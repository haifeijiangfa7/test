...
import { Play, Trash2, Link, User, Crown } from "lucide-react";
...
export default function CreditTasks() {
  ...
  // 普通账号模式
  const [normalAccountId, setNormalAccountId] = useState("");
  const [normalTargetCredits, setNormalTargetCredits] = useState("2500");
  
  // 会员账号模式
  const [vipAccountId, setVipAccountId] = useState("");
        ...
        <TabsContent value="invite_only">
          <Card>
            <CardHeader>
              ...
              <CardDescription>只需提供邀请链接，设置邀请次数即可执行邀请</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="normal_account">
          <Card>
            <CardHeader>
              ...
              <CardDescription>选择或随机获取普通账号，制作指定积分的账号</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>账号来源</Label>
                <Select value={normalAccountId} onValueChange={setNormalAccountId}>
                  ...
                  <SelectContent>
                    <SelectItem value="">随机获取</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNormalTargetCredits(e.target.value)}
                />
              </div>
              <p className="text-sm text-gray-500">
                可用普通账号: {accounts?.length || 0} 个 | 可用被邀请账号: {inviteeCount?.count || 0} 个
              </p>
              <Button 
        ...
        <TabsContent value="vip_account">
          <Card>
            <CardHeader>
              ...
              <CardDescription>选择或随机获取会员账号，制作指定积分的账号</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>账号来源</Label>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setVipTargetCredits(e.target.value)}
                />
              </div>
              <p className="text-sm text-gray-500">
                可用会员账号: {vipAccounts?.length || 0} 个 | 可用被邀请账号: {inviteeCount?.count || 0} 个
              </p>
              <Button 
